...
class _ComplainsState extends State<Event> {
  EventService get service => GetIt.I<EventService>();

  APIResponse<List<EventForListing>> _apiResponse;
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        appBar: AppBar(title: Text('List Of Special Event')),
              ...
              itemBuilder: (_, index) {
                return Dismissible(
                  ...
                  confirmDismiss: (direction) async {
                    ...
                    // if (result) {
                    //   final deleteResult = await service.deleteNote(_apiResponse.data[index].Event_name);
                    //
                    //   var message;
...
//   Widget build(BuildContext context) {
//     return Scaffold(
//         appBar: AppBar(title: Text('List Of Event')),
//         floatingActionButton: FloatingActionButton(
//           onPressed: () {
//             Navigator.of(context)
//                 .push(MaterialPageRoute(builder: (_) => EventModify()))
