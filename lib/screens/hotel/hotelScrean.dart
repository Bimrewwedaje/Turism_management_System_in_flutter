...
class _ComplainsState extends State<Hotel> {
  HotelService get service => GetIt.I<HotelService>();

  APIResponse<List<HotelForListing>> _apiResponse;
...
final urlHotel = Image;
  ...
  _fetchNotes() async {
    ...
    _apiResponse = await service.getHotelList();
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        appBar: AppBar(title: Text('List Of Hotel')),
        floatingActionButton: FloatingActionButton(
          onPressed: () {
            Navigator.of(context)
                .push(MaterialPageRoute(builder: (_) => HotelModify()))
                .then((_) {
              _fetchNotes();
            });
          },
        ...
        body: Builder(
          builder: (_) {
            ...
            return ListView.separated(
              ...
              itemBuilder: (_, index) {
                return Dismissible(
                  key: ValueKey(_apiResponse.data[index].Hotel_name),
                  ...
                  confirmDismiss: (direction) async {
                    ...
                    if (result) {
                      final deleteResult = await service.deleteNote(_apiResponse.data[index].Hotel_name);
                  ...
                  child: ListTile(
                    title: Text(
                        _apiResponse.data[index].Hotel_name),
                    onTap: () {
